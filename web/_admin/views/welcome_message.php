...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="/public/admin/images/user.png" width="48" height="48" alt="User" />
                </div>
    ...
    <script src="/public/admin/plugins/flot-charts/jquery.flot.js"></script>
    <script src="/public/admin/plugins/flot-charts/jquery.flot.resize.js"></script>
    <script src="/public/admin/plugins/flot-charts/jquery.flot.pie.js"></script>
    <script src="/public/admin/plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="/public/admin/plugins/flot-charts/jquery.flot.time.js"></script>
