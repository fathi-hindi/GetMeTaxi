...
define('RENTALS_BOOKING_ENABLE', true);
...
define('ADDRESS_STATUS_TEMPORARY', 'T');

// ORDERS STATUS
define('ORDERS_STATUS_PENDING', 'P');
define('ORDERS_STATUS_COMPLETED', 'C');
define('ORDERS_STATUS_CANCELES', 'X');
define('ORDERS_STATUS_IN_PROGRESS', 'I');
define('ORDERS_STATUS_REJECTED', 'R');
define('ORDERS_STATUS_SUBMITTED', 'S');
