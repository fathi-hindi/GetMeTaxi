                        ...
                        <div class="row">
                                ...
                                <div class="search-tabs search-tabs-bg mt50">
                                    ...
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab">
											...
											<?php }  ?>
											<?php if (RENTALS_BOOKING_ENABLE) { ?>
                                            <li <?php if ($acive) { $acive = false; echo "class='active'"; } ?>>
												<a href="#tab-3" data-toggle="tab"><i class="fa fa-home"></i> <span >Rentals</span></a>
                                            </li>
											<?php }  ?>
                                                    ...
                                                    <div class="input-daterange" data-date-format="M d, D">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
															 ...
															 <div class="col-md-6">
                                                                <div class="form-group form-group-lg form-group-icon-left">
                                                                    <label>Finalize your booking booking booking</label>
																	<button class="btn btn-primary btn-lg" type="submit">Booking Now</button>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="loc-info text-right hidden-xs hidden-sm">
                                    <h3 class="loc-info-title">Nablus</h3>
